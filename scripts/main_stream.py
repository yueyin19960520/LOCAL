...
if __name__ == "__main__":
    ...
    model_training_flags = {"POS2CLS":False, "POS2COHP":False, "POS2E": True}
    ...
    pos2e = POS2E(dataset_model_dict_with_PRED, split_ratio=0.8, batch_size=96, dim=256, epochs=200, verbose=True)
