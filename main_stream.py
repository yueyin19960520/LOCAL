...
if model_training_flags["POS2COHP"]:
    pos2cohp_dataset = pos2cohp.train_all_models(enc_type='onehot') # encode type
import pickle
...
#                     split_ratio=0.9, batch_size=48, conv_dim_list=[[256,256],[256,256],[256,256],[256,256],], dim=256,
#                     epochs=300, verbose=True)
# # cont2ewithoutcohp.build_raw_data_dict()
# cont2ewithoutcohp.train_all_models()
# #%%
...
#     # cont2ewithoutcohp.build_raw_data_dict()
#     pos2ewithoutcohp.train_all_models()
#%%
...
for i in range(1):
    ...
    with open('./dataset_model_dict_with_PRED', 'rb') as file:
        dataset_model_dict_with_PRED = pickle.load(file)
    pos2e = POS2E_edge(dataset_model_dict_with_PRED, split_ratio=0.9, batch_size=48, dim=256, epochs=300, 
                linear_dim_list=[],
                conv_dim_list=[[256,256],[256,256],[256,256],[256,256],],verbose=True,
                edge_dim=1)
    pos2e.build_raw_data_dict() 
