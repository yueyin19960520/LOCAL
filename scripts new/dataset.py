...
class POS2E_Dataset(Dataset):
    def __init__(self, root, src_dataset=None, predicted_value=None, raw_data_dict=None, setting=None, suffix=None, 
    ...
    def process(self):
        ...
        augs = [enumerate_padding_structure(ori_pos) for ori_pos in ori_poss]
