...
class POS2E_edge():
    ...
    def train_single_model(self, suffix, dataset, setting, PRED,pool_type,
                           aug,maximum_num_atoms,real_cohp,noise,noise_type,noise_mae):
        ...
        best = 1e5
        log_file = "./models/POS2E_Net_%s_%s.txt"%(suffix,file_name_current_time)
        with open(log_file, 'w') as file:
            file.close()
        noise_info = f'real cohp? {real_cohp},noise:{noise},noise_type:{noise_type},noise_mae:{noise_mae}'
